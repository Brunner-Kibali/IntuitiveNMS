...
import intuitiveNMS.models.reset
from intuitiveNMS import app
...
from intuitiveNMS.controller.device.device_info import get_device_info
from intuitiveNMS.controller.host.portscan import get_port_scan_tcp_connection
...
def reset_devices():
    ...
    intuitiveNMS.models.reset.reset_devices()
...
def reset_hosts():
    ...
    intuitiveNMS.models.reset.reset_hosts()
...
def reset_services():
    ...
    intuitiveNMS.models.reset.reset_services()
...
def reset_events():
    intuitiveNMS.models.reset.reset_events()
    return "Events table reset"


@app.route("/ui/reset/capture", methods=["POST"])
def reset_capture():
    intuitiveNMS.models.reset.reset_capture()
