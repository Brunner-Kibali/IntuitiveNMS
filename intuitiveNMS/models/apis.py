...
from intuitiveNMS.models.Worker import Worker
...
from intuitiveNMS.models.HostStatusSummary import HostStatusSummary
from intuitiveNMS.models.ServiceStatusSummary import ServiceStatusSummary

from intuitiveNMS.models.DeviceConfig import DeviceConfig

from intuitiveNMS.models.util import get_model_as_dict
...
def import_devices(filename=None, filetype=None):
    ...
    with open("intuitiveNMS/data/" + filename, "r") as import_file:
