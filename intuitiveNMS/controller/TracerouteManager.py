...
import json
import yaml
from intuitiveNMS.controller.utils import log_console, get_this_ip
from intuitiveNMS.models.apis import get_worker, set_command
...
class TracerouteManager:
    ...
    try:
        with open("intuitiveNMS/data/" + "traceroute_monitors.yaml", "r") as import_file:
    ...
    def get_channel(monitor):
        ...
        credentials = pika.PlainCredentials("intuitive-nms", "admin123!")
