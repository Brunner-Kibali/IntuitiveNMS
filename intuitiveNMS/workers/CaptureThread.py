from kamene.all import sniff, hexdump, conf, get_if_list, get_if_addr
...
class CaptureThread(Thread):
    def __init__(self, intuitivenms_ip, serial_no, capture_info):

        super().__init__()

        print(
            f"CaptureThread: initializing thread object: intuitiveNMS_ip={intuitivenms_ip}, serial={serial_no}, "
            f"capture info={capture_info} "
        )
        ...
        self.intuitivenms_ip = intuitivenms_ip
